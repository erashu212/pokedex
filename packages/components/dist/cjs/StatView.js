...
const StackView = ({ title, content }) => {
    return (React.createElement(material_1.Stack, { direction: "row", divider: React.createElement(material_1.Divider, { orientation: "vertical", flexItem: true }), spacing: 2 },
